...
class MMS_Variables_List_Names(ASN1_Packet):
    ...
    ASN1_root = ASN1F_VARIABLES_LIST_NAMES(
        ASN1F_CHOICE(
            ...
            MMS_VMD_Specific(), # I think this is wrong 
            MMS_VMD_Specific,
            MMS_Domain_Specific,
            MMS_AA_Specific
        )
...
class MMS_Data(ASN1_Packet):
    ...
    ASN1_root = ASN1F_CHOICE(
        'data',
        None,
        # MMS_Data_Array, -- Forward declared below
        # MMS_Data_Structure, -- Forward declared below
        MMS_Data_Boolean,
        MMS_Data_BitString,
        MMS_Data_Int,
        MMS_Data_UInt,
...
class MMS_Data_Structure(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_DATA_STRUCTURE(
        "data_structure",
        None,
        MMS_Data
    )

class MMS_Data_Array(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_DATA_ARRAY(
        "data_array",
        None,
        MMS_Data
    )

# Update MMS_Data to include MMS_Data_Array and MMS_Data_Structure
MMS_Data.ASN1_root = ASN1F_CHOICE(
    'data',
    None,
    MMS_Data_Array,
    MMS_Data_Structure,
